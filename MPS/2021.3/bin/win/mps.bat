...
:: Generated by MPS
::----------------------------------------------------------------------
SET IDEA_PATHS_SELECTOR=MPS2021.3
SET PRODUCT=MPS
...
SET BITS=64
SET USER_JDK64_FILE=%APPDATA%\%IDEA_VENDOR_NAME%\MPS2021.3\mps%BITS%.exe.jdk
SET BITS=
SET USER_JDK_FILE=%APPDATA%\%IDEA_VENDOR_NAME%\MPS2021.3\mps%BITS%.exe.jdk
